...
if __name__ == "__main__":
    ...
    parser.add_argument('inputFile',
                        help="Text file that contains the numbers that will be used to calculate the metrics (one number per line)",
                        type=str)
    ...
    parser.add_argument("--coefficient-of-variability", action="store_true",
                        help="calculate coefficient of variability")
